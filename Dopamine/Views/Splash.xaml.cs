...
namespace Dopamine.Views
{
    public partial class Splash : Window
    {
        ...
        private void ShowErrorDetails()
        {
            ...
            string path = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.Desktop), ProductInformation.ApplicationName + "_" + currentTimeString + ".txt");
        ...
        private async Task<bool> CheckWindowsMediaFoundationAsync()
        {
            ...
            if (!isSuccess)
            {
                this.errorMessage = "Windows Media Foundation was not found on your computer. It is required by " + ProductInformation.ApplicationName + " to play audio." + Environment.NewLine +
