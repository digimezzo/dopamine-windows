...
namespace Dopamine.Views
{
    public partial class TrayControls : Window
    {
        ...
        public void Show()
        {
            LogClient.Current.Info("Showing tray controls");
        ...
        private void SetGeometry()
        {
            ...
            LogClient.Current.Info("Tray controls position: Taskbar position = {0}, Left = {1}px, Top = {2}px", taskbar.Position.ToString(), this.Left.ToString(), this.Top.ToString());
        }
        #endregion
    }
}
