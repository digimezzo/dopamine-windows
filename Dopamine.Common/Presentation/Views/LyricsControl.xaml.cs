...
namespace Dopamine.Common.Presentation.Views
{
    public partial class LyricsControl : UserControl
    {
        ...
        private void LyricsListBox_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                CoreLogger.Error("Could not get lyricsListBox from the DataTemplate. Exception: {0}", ex.Message);
            }
        }
        ...
        private void LyricsTextBox_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                CoreLogger.Error("Could not get lyricsTextBox from the DataTemplate. Exception: {0}", ex.Message);
            }
        }
        ...
        private async void ScrollToHighlightedLyricsLineAsync()
        {
            ...
            {
                CoreLogger.Error("Could not scroll to the highlighted lyrics line. Exception: {0}", ex.Message);
            }
        }
        #endregion
        ...
        private void EditMenuItem_Click(object sender, RoutedEventArgs e)
        {
            if (this.lyricsTextBox != null)
            {
                ...
                {
                    CoreLogger.Error("Could not set focus on lyricsTextBox. Exception: {0}", ex.Message);
                }
        ...
        private void AddTimeStampToSelectedLyricsLine()
        {
            if (this.lyricsTextBox != null)
            {
                ...
                {
                    CoreLogger.Error("Could not add timeStamp to selected lyrics line. Exception: {0}", ex.Message);
                }
            }
        }
    }
