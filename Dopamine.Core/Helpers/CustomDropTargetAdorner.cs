...
{
    public class CustomDropTargetAdorner : DropTargetAdorner
    {
        public CustomDropTargetAdorner(UIElement adornedElement) : base(adornedElement)
        {
        }
        ...
        static CustomDropTargetAdorner()
        {
            // Create the pen and triangle in a static constructor and freeze them to improve performance.
            const int triangleSize = 5;

            m_Pen = new Pen(Brushes.Red, 2);
            m_Pen.Freeze();
