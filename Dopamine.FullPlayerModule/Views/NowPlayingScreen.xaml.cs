...
namespace Dopamine.FullPlayerModule.Views
{
    public partial class NowPlayingScreen : UserControl
    {
        ...
        private void NowPlaying_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            try
            {
                NowPlayingSpectrumAnalyzerRegion.Margin = new Thickness(Convert.ToInt32(this.ActualWidth / 2) - Convert.ToInt32(NowPlayingSpectrumAnalyzerRegion.ActualWidth / 2), 0, 0, 0);
            }
            catch (Exception)
            {
